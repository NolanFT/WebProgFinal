    ...
    public function run(): void
    {
        DB::table('products')->insert([
            ...
            [
                ...
                'description' => 'Collectible 15cm articulated hero action figure with display stand. Made in: China. Color: Blue suit.',
                'quantity'    => 12,
                'category_id' => 2,
            ],
            [
                ...
                'description' => 'Same hero model with alternate colorway. Made in: China. Color: Red suit.',
                'quantity'    => 8,
                'category_id' => 2,
            ],
            ...
            [
                ...
                'description' => 'Paperback novel, 420 pages. Genre: Fantasy / Thriller. Printed in: Indonesia. Cover color: Dark blue.',
                'quantity'    => 20,
                'category_id' => 3,
            ],
            [
                ...
                'description' => 'Full-color comic, first volume of The Boys series. Printed in: Malaysia. Cover color: Black / Red.',
                'quantity'    => 18,
                'category_id' => 3,
            ],
            ...
            [
                ...
                'description' => 'Unisex cotton graphic T-shirt with The Boys logo. Made in: Indonesia. Color: Black. Sizes: S–XL.',
                'quantity'    => 25,
                'category_id' => 4,
            ],
            [
                ...
                'description' => 'Same model as TB-TS01 with inverted colorway. Made in: Indonesia. Color: White. Sizes: S–XL.',
                'quantity'    => 20,
                'category_id' => 4,
            ],
            [
                ...
                'description' => 'Fleece hoodie with front pocket and embroidered The Boys logo. Made in: Bangladesh. Color: Charcoal Grey.',
                'quantity'    => 10,
                'category_id' => 4,
            ],
            ...
            [
                ...
                'description' => 'Pack of 5 spicy instant ramen servings. Made in: Korea. Flavor: Extra Spicy. Color: Red / Black packaging.',
                'quantity'    => 40,
                'category_id' => 6,
            ],
            [
                ...
                'description' => '100% Arabica whole beans, medium roast. Origin: Indonesia (Sumatra). Packaging color: Brown / Gold.',
                'quantity'    => 22,
                'category_id' => 6,
            ],
        ]);
